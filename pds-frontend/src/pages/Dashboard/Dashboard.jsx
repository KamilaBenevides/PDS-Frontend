  ...
  return (
    <>
      ...
      <div style={{ padding: '10px' }}>
        ...
        <Row gutter={[16, 16]}>
          <Col span={8}>
            <SpecificStats title={"Total"} vencidos={stats.totalVencidos} enviados={stats.totalEnviados} abertos={stats.totalAbertos} detalhes={path.LIST_REGISTER} setSucesso={setSucesso} setErro={setErro} />
          </Col>
          <Col span={8}>
