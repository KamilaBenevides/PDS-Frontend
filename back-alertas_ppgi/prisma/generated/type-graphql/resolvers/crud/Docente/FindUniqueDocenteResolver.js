...
exports.FindUniqueDocenteResolver = void 0;
...
let FindUniqueDocenteResolver = class FindUniqueDocenteResolver {
...
], FindUniqueDocenteResolver.prototype, "docente", null);
FindUniqueDocenteResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Docente_1.Docente)
], FindUniqueDocenteResolver);
exports.FindUniqueDocenteResolver = FindUniqueDocenteResolver;
